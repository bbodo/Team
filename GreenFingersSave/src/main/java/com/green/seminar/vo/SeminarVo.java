...
public class SeminarVo {
	// Fields
		...
		// Constructor
		public SeminarVo() {}
		public SeminarVo(int board_idx, String submenu_id, String board_title, String board_cont, int market_value,
		...
		public String toString() {
			return "BoardVo [board_idx=" + board_idx + ", submenu_id=" + submenu_id + ", board_title=" + board_title
					+ ", board_cont=" + editorTxt + ", market_value=" + market_value + ", usercode=" + usercode
