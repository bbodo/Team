...
public class MarketVo {
	...
	// Constructor
	public MarketVo() {}
	public MarketVo(int board_idx, String submenu_id, String board_title, String board_cont, int market_value,
			int usercode, int managercode, String board_regdate, int readcount, int bnum, int lvl, int step, int nref,
			int delboard, int parent, String userid, String nickname, int nowpage, int pagecount, int totalcount, int totalpagecount,
	...
	public String toString() {
		return "MarketVo [board_idx=" + board_idx + ", submenu_id=" + submenu_id + ", board_title=" + board_title
				...
				+ ", parent=" + parent + ", userid=" + userid + ", nickname=" + nickname + ", nowpage=" + nowpage + ", pagecount=" + pagecount
