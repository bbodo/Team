...
public class MarketServiceImpl implements MarketService {
	...
	@Override
	public List<MarketVo> getMarketList(HashMap<String, Object> map) {
		// 필요한 자료를 조회( rows)
		...
		MarketPaging mp = new MarketPaging(submenu_id, nowpage, pagecount, totalcount, pagetotalcount);
	...
	public void productPay(HashMap<String, Object> map) {
		 ...
		 int point = Integer.parseInt( String.valueOf(map.get("point")) ) - (
		 Integer.parseInt(String.valueOf(map.get("market_value"))) *
		 Integer.parseInt(String.valueOf(map.get("transaction_su"))) );
		  
		 map.put("point", point);
		 marketDao.productPay(map); 
		 //System.out.println("스토어 포인트"+ point);
		 
		 //System.out.println("스토어" + map);
	}
