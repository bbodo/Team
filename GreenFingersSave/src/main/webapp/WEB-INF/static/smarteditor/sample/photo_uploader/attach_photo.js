    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/Manager/SeminarSmarteditor'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/Manager/SeminarSmarteditor',	//샘플 URL입니다.
 	        sCallback : '/Manager/SeminarWrite?nowpage=1',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
