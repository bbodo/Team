...
<%@include file="/WEB-INF/include/adminsubBanner.jsp" %>
     ...
     <div id="main">
     	<form action="/Manager/subMenuWrite" method="POST">
		<div class="findid_wrap">
		<h2 style="font-size: 20px; margin: 20px 0px;">상위 메뉴</h2>
		<select name="menu_id" class="ps_box">
		...
		<h2 style="font-size: 20px; margin: 20px 0px;">메뉴 이름</h2>
			<div class="input_row">
				<input type="text" name="submenu_name" id="submenu_name" style="border: none; font-size: 25px; width: 100%;"/>
		</div>
